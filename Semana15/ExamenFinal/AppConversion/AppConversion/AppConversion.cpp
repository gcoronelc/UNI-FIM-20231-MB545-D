...
// AppConversion.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CAppConversionApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CAppConversionApp

CAppConversionApp::CAppConversionApp()
{
...
// Único objeto CAppConversionApp

CAppConversionApp theApp;


// Inicialización de CAppConversionApp

BOOL CAppConversionApp::InitInstance()
{
