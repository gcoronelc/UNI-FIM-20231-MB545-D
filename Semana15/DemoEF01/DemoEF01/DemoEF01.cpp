...
// DemoEF01.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CDemoEF01App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CDemoEF01App

CDemoEF01App::CDemoEF01App()
{
...
// Único objeto CDemoEF01App

CDemoEF01App theApp;


// Inicialización de CDemoEF01App

BOOL CDemoEF01App::InitInstance()
{
